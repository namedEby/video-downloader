  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FancyBottomNavigation(
        ...
        tabs: [
        TabData(iconData:FontAwesomeIcons.facebook, title: "FaceBook"),
        TabData(iconData:FontAwesomeIcons.instagram, title: "Instagram"),
        TabData(iconData:FontAwesomeIcons.whatsapp, title: "WhatsApp"),
        ],
